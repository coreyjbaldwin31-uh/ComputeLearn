...

        {
          ...
          lessons: [
            ...
            },
            {
              ...
              explanation: [
                "Documentation is not extra work after the real work is done. It is part of the deliverable. A project without documentation is a project that only works while you are in the room.",
                "This lesson covers three levels of documentation: project-level (README), code-level (comments and naming), and change-level (commit messages and PR descriptions). Each serves a different audience at a different time.",
              ],
              demonstration: [
                "The demo compares two READMEs for the same project: one says 'a task app' with no setup steps; the other explains what the project does, how to install it, how to run it, and how to run tests. The difference in usability is immediate.",
                "It then shows a function with zero comments vs. one with a single-line doc comment explaining the why, not the what. Good comments explain intent, not mechanics.",
              ],
              exerciseSteps: [
                "Write a README for a sample project that covers purpose, setup, usage, and testing.",
                "Add a one-line doc comment to each exported function in a sample file explaining why the function exists.",
                "Write a pull request description for a hypothetical change that explains what changed, why, and how to verify it.",
              ],
              validationChecks: [
                "README includes purpose, setup, usage, and test instructions.",
                "Comments explain intent, not implementation details.",
                "PR description includes what, why, and verification steps.",
              ],
              retention: [
