              ...
              exercises: [
                {
                  ...
                  title: "Safety first",
                  prompt:
                    "What PowerShell parameter should you add to a destructive command like `Remove-Item` to preview what would be deleted without actually deleting?",
                  ...
                  hint: "This parameter simulates the command without making changes. It appears in the demonstration where we used Remove-Item.",
                  assessmentType: "action",
                },
                {
                  id: "variable-store",
                  title: "Store a value",
                  prompt:
                    "In PowerShell, what single character prefix marks a variable name?",
            ...
            },
            {
              ...
              exercises: [
                ...
                },
                {
                  ...
                  validationMode: "includes",
                  acceptedAnswers: ["$file", "$item", "$f", "$element", "$entry", "$_", "$log", "$x", "$i", "$obj"],
                  successMessage:
                ...
                },
                {
                  ...
                  prompt:
                    "Given a variable `$score = 45`, will the code `if ($score -gt 50) { 'Pass' } else { 'Fail' }` print 'Pass' or 'Fail'?",
                  placeholder: "Keyword",
                  validationMode: "exact",
                  acceptedAnswers: ["Fail", "fail", "'Fail'"],
                  successMessage:
                    "Correct. Since 45 is not greater than 50, the else block executes. The `-gt` operator means 'greater than'.",
          ...
          lessons: [
            {
              ...
              exercises: [
                ...
                },
                {
                  ...
                  title: "Why backlink?",
                  prompt:
                    "In Obsidian, what is a **backlink** and what does `[[note-name]]` syntax create?",
                  placeholder: "Short answer",
                  validationMode: "includes",
                  acceptedAnswers: [
                    "link between",
                ...
                },
                {
                  ...
                  hint: "Think about the three types of notes described in the explanation: daily, reference, and project notes.",
          ...
          lessons: [
            ...
            },
            {
              ...
              exercises: [
                ...
                },
                {
                  ...
                  prompt:
                    "What field in `package.json` defines the commands you can run with `npm run <name>`?",
                  placeholder: "Field name",
                  validationMode: "exact",
                  acceptedAnswers: ["scripts", "\"scripts\""],
                  successMessage:
                    "Correct. The `scripts` field maps command names to shell commands. Running `npm run dev` executes whatever command is defined under `scripts.dev`.",
                  hint: "Look at the package.json demonstration — this field contains entries like `dev`, `build`, `lint`, and `test`.",
                  assessmentType: "action",
                },
              ],
              transferTask: {
            ...
            },
            {
              ...
              demonstration: [
                ...
                "Here is what happens when things go wrong — these are the errors you will see most often when starting out:\n\n```ts\n// ERROR: Assignment to constant variable\nconst name: string = 'Alice';\nname = 'Bob';\n// TypeError: Assignment to constant variable.\n```\n\nTypeScript and the runtime both catch this — `const` means the binding cannot change. Use `let` if you need reassignment.\n\n```ts\n// ERROR: Wrong argument count\nfunction greet(name: string): string {\n  return `Hello, ${name}!`;\n}\ngreet(); // Expected 1 arguments, but got 0.\ngreet('Alice', 'Bob'); // Expected 1 arguments, but got 2.\n```\n\nTypeScript catches argument mismatches at compile time — you see the red underline in VS Code before you even run the code.\n\n```ts\n// ERROR: Type mismatch\nlet score: number = 0;\nscore = 'ten';\n// Type 'string' is not assignable to type 'number'.\n```\n\nType annotations prevent this entire category of bugs. Without them, JavaScript would silently accept `'ten'` and fail later during math operations.",
              ],
              exerciseSteps: [
              ...
              transferTask: {
                ...
                prompt:
                  "A function receives an array of student scores (numbers). It should return an object with three counts: how many scored 'high' (above 80), 'mid' (50–80), and 'low' (below 50). Write the TypeScript function with type annotations, using a loop and conditionals. Then name one edge case you would test.",
                placeholder: "function classify(value: number): ...",
                validationMode: "includes",
                acceptedAnswers: ["number[]", "forEach", "for", "high", "mid", "low", "edge", "empty", "boundary", "loop", ": {"],
                successMessage:
                  "Transfer evidence accepted. You combined typed parameters, loop iteration, conditional branching, and test thinking in a single function.",
                hint: "You need: a typed parameter (number[]), an accumulator object, a loop, and if/else if/else branches. What happens with an empty array or a score of exactly 50?",
                assessmentType: "transfer",
              },
              codeExercises: [
                {
            ...
            },
            {
              ...
              demonstration: [
                ...
                "Here is what happens when common data structure mistakes occur — you will see these errors frequently:\n\n```typescript\n// Accessing an index that doesn't exist\nconst items = ['a', 'b', 'c'];\nconsole.log(items[10]); // undefined (no error — silent failure!)\n```\n\nJavaScript does **not** throw an error for out-of-bounds array access. It silently returns `undefined`, which can propagate through your code and cause confusing bugs much later.\n\n```typescript\n// Accessing a property on undefined (the #1 runtime error)\nconst users = [{ name: 'Alice', address: { city: 'Seattle' } }];\nconsole.log(users[1].name);\n// TypeError: Cannot read properties of undefined (reading 'name')\n```\n\n`users[1]` is `undefined` because the array only has one element (index 0). Trying to read `.name` on `undefined` crashes the program. The fix: check that the value exists first, or use **optional chaining**: `users[1]?.name` returns `undefined` safely instead of crashing.\n\n```typescript\n// Forgetting that .filter() and .map() return NEW arrays\nconst scores = [72, 85, 91, 68];\nscores.filter(s => s >= 80);\nconsole.log(scores); // [72, 85, 91, 68] — unchanged!\n\n// The filtered result was discarded. You must capture the return value:\nconst passing = scores.filter(s => s >= 80);\nconsole.log(passing); // [85, 91]\n```\n\nThis is one of the most common beginner mistakes with array methods — calling the method but not storing the result.",
              ],
              exerciseSteps: [
              ...
              exercises: [
                {
                  ...
                  validationMode: "exact",
                  acceptedAnswers: ["{}", "{ }", "curly braces", "braces"],
                  successMessage:
                    "Correct. Curly braces delimit a JSON object; square brackets delimit an array.",
                  hint: "Think about the punctuation marks that open and close a JSON object.",
                  assessmentType: "action",
                },
                {
...
`,
            ...
            },
            {
              ...
              transferTask: {
                ...
                prompt:
                  "A teammate says: 'My API route works locally but crashes in production.' They have no error message yet. Describe the three things you would ask them to show you, explain where in a stack trace you would look first, and name one common cause of ReferenceError in Node.js API code.",
                placeholder:
                ...
                successMessage:
                  "Transfer evidence accepted. You demonstrated the ability to diagnose errors from incomplete information using structured inquiry.",
                hint: "Start with getting the actual error. Then read the stack trace from the top. Consider what changes between local and production environments.",
                assessmentType: "transfer",
              },
              competencies: [{ track: "Debugging", targetLevel: "Functional" }],
              scaffoldingLevel: "goal-driven",
          ...
          lessons: [
            {
              ...
              transferTask: {
                ...
                prompt:
                  "You accidentally deleted a function from your main file three commits ago and only notice now. Using Git commands, describe the sequence you would follow to: find which commit removed the function, view the deleted code, and recover it without losing your current work.",
                ...
                successMessage:
                  "Transfer evidence accepted. You demonstrated independent Git recovery using log, diff, and restore commands.",
                hint: "Use git log to find the commit, git diff or git show to view the change, and git checkout or git restore to recover the file from that commit.",
                assessmentType: "transfer",
              },
              codeExercises: [
                {
          ...
          lessons: [
            ...
            },
            {
              ...
              exercises: [
                {
                  ...
                  prompt:
                    "Write the Postman syntax to reference an environment variable called `baseUrl`.",
                  placeholder: "{{...}}",
                  validationMode: "exact",
                  acceptedAnswers: [
                    "{{baseUrl}}",
                  ...
                  hint: "Variables in Postman use a special double-curly-brace syntax.",
                  assessmentType: "action",
                },
                {
              ...
              transferTask: {
                ...
                prompt:
                  "You receive API documentation for a user management service with six endpoints. Describe: how you would organize a Postman collection to test it, what collection-level variables you would define, how you would chain a create-then-verify sequence using test scripts, and one thing that would break if you hardcoded the base URL instead of using a variable.",
                ...
                successMessage:
                  "Transfer evidence accepted. You demonstrated collection design, variable strategy, and test chaining for professional API testing.",
                hint: "Think about structure (folders per resource), reusability (variables for URLs and IDs), and automation (test scripts that verify each response). What happens when you switch from dev to staging?",
                assessmentType: "transfer",
              },
              codeExercises: [
                {
          ...
          lessons: [
            {
              ...
              transferTask: {
                ...
                prompt:
                  "A container starts successfully but the web app inside returns 'connection refused' from the host machine. Describe the Docker commands you would run in order to diagnose this, what you would look for in each command's output, and the single most likely cause based on the symptoms.",
                ...
                successMessage:
                  "Transfer evidence accepted. You connected symptoms to Docker networking concepts and proposed a systematic diagnostic sequence.",
                hint: "Start with docker ps to check if the container is running and which ports are mapped. Then check docker logs for errors. The most common cause of 'connection refused' is a port mapping issue.",
                assessmentType: "transfer",
              },
              codeExercises: [
                {
          ...
          lessons: [
            {
              ...
              demonstration: [
                "**Vague prompt → vague output.** Here is a prompt with almost no constraints:\n\n```text\nWrite a function to validate emails.\n```\n\nA typical AI response — it picks a language for you, skips edge cases, and gives you no tests:\n\n```javascript\nfunction validateEmail(email) {\n  const regex = /^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$/;\n  return regex.test(email);\n}\n```\n\nNo types, no named function contract, no edge-case handling for empty strings, no tests. Now compare with a **precise engineering prompt**:\n\n```text\nWrite a TypeScript function called isValidEmail that:\n- Takes a single string parameter\n- Returns boolean\n- Returns false for empty strings, strings without @, and strings where @ is the first or last character\n- Does NOT use regex — use string methods only\n- Include a Vitest test covering: valid email, empty string, missing @, @ at start, @ at end\n```\n\nThe AI now produces code that matches your specification:\n\n```typescript\nexport function isValidEmail(email: string): boolean {\n  if (email.length === 0) return false;\n  const atIndex = email.indexOf(\"@\");\n  if (atIndex === -1) return false;\n  if (atIndex === 0) return false;\n  if (atIndex === email.length - 1) return false;\n  return true;\n}\n```\n\n```typescript\nimport { describe, it, expect } from \"vitest\";\nimport { isValidEmail } from \"./isValidEmail\";\n\ndescribe(\"isValidEmail\", () => {\n  it(\"returns true for a valid email\", () => {\n    expect(isValidEmail(\"user@example.com\")).toBe(true);\n  });\n  it(\"returns false for an empty string\", () => {\n    expect(isValidEmail(\"\")).toBe(false);\n  });\n  it(\"returns false when @ is missing\", () => {\n    expect(isValidEmail(\"userexample.com\")).toBe(false);\n  });\n  it(\"returns false when @ is the first character\", () => {\n    expect(isValidEmail(\"@example.com\")).toBe(false);\n  });\n  it(\"returns false when @ is the last character\", () => {\n    expect(isValidEmail(\"user@\")).toBe(false);\n  });\n});\n```\n\nSame task, dramatically different output. The precise prompt specified language, function name, return type, every edge case, an implementation constraint (no regex), and exactly which tests to write.",
                "**Checklist review: verify the AI output against the prompt.** Take the output from the precise prompt and walk through each requirement:\n\n```text\n✅ TypeScript?                    — Yes, typed parameter and return type\n✅ Function named isValidEmail?   — Yes\n✅ Takes a single string param?   — Yes (email: string)\n✅ Returns boolean?               — Yes\n✅ Empty string → false?          — Yes, first check\n✅ Missing @ → false?             — Yes, atIndex === -1\n✅ @ at start → false?            — Yes, atIndex === 0\n✅ @ at end → false?              — Yes, atIndex === email.length - 1\n✅ No regex used?                 — Yes, uses indexOf and length\n✅ Vitest tests for all 5 cases?  — Yes, five it() blocks\n```\n\nNow confirm mechanically. Run the type checker and tests:\n\n```bash\n$ npx tsc --noEmit\n# No errors — types are correct\n\n$ npx vitest run isValidEmail.test.ts\n ✓ isValidEmail > returns true for a valid email\n ✓ isValidEmail > returns false for an empty string\n ✓ isValidEmail > returns false when @ is missing\n ✓ isValidEmail > returns false when @ is the first character\n ✓ isValidEmail > returns false when @ is the last character\n\nTest Files  1 passed (1)\n     Tests  5 passed (5)\n```\n\nEvery line in the checklist maps to a constraint in the original prompt. This is why precise prompts create **verifiable** output — you wrote the acceptance criteria before the code existed.",
                "**Bad prompt, bad output — a cautionary example.** Consider this prompt:\n\n```text\nWrite code to handle user data.\n```\n\nThe AI has to guess everything. A plausible response:\n\n```python\ndef handle_user_data(data):\n    for user in data:\n        print(user[\"name\"])\n        print(user[\"email\"])\n    return data\n```\n\nWhat went wrong? The prompt was missing every constraint that matters:\n\n```text\n❌ No language specified        → AI picked Python; you needed TypeScript\n❌ No data shape defined        → AI assumed a list of dicts with \"name\" and \"email\"\n❌ No operation specified        → AI just printed fields — is this a transform? validation? storage?\n❌ No error handling requested   → No null checks, no try/catch, no validation\n❌ No return type defined        → Returns the raw input unchanged\n❌ No tests requested            → No way to verify correctness\n```\n\nEvery missing constraint became a wrong assumption. A prompt that said *\"Write a TypeScript function called normalizeUser that takes a `{ name: string; email: string }` object, trims whitespace from both fields, lowercases the email, returns the cleaned object, throws if either field is empty after trimming, and include Vitest tests for valid input, empty name, and empty email\"* would have produced usable code on the first try. **The prompt is your specification — if it is vague, the output will be too.**",
              ],
              exerciseSteps: [
              ...
              exercises: [
                {
                  ...
                  prompt:
                    "A developer says \u2018write a function to sort data.\u2019 Name TWO critical constraints that are missing from this prompt.",
                  placeholder: "Short answer",
                  validationMode: "includes",
                  acceptedAnswers: [
                    "language",
                  ...
                  hint: "Think about what you would need to know before writing the function yourself \u2014 the language, the data type, and the sort order.",
                  assessmentType: "reasoning",
                },
                {
                  ...
                  prompt:
                    "Fill in the blank: A prompt without edge cases produces code that only handles the _____ path.",
                  placeholder: "Short answer",
                  validationMode: "exact",
                  acceptedAnswers: [
                    "happy",
                  ...
                  successMessage:
                    "Correct. Without explicit edge cases, AI-generated code typically only handles the happy path and breaks on unexpected input.",
                ...
                },
                {
                  ...
                  prompt:
                    "What specific sentence should you add to an AI prompt to ensure the output includes automated tests?",
                  placeholder: "Short answer",
                  validationMode: "includes",
                  acceptedAnswers: [
                    "include a test",
                  ...
                  hint: "The explanation shows this pattern: adding 'include a test that covers...' to the end of the prompt.",
                  assessmentType: "reasoning",
                },
              ],
              transferTask: {
            ...
            },
            {
              ...
              demonstration: [
                "**The automated verification loop.** You prompt an AI to generate a currency formatter. It produces this:\n\n```typescript\n// utils/formatCurrency.ts — AI-generated draft\nexport function formatCurrency(amount: number, locale: string): string {\n  const formatted = new Intl.NumberFormat(locale, {\n    style: \"currency\",\n    currency: \"USD\",\n  }).format(amount);\n  return formatted;\n}\n```\n\nBefore touching anything else, run the automated checks. First, type checking:\n\n```bash\n$ npx tsc --noEmit\nutils/formatCurrency.ts(2,54): error TS2345: Argument of type\n  'string' is not assignable to parameter of type\n  '\"USD\" | \"EUR\" | \"GBP\" | ...'\n```\n\nThe AI hardcoded `\"USD\"` but your project passes currency as a parameter. Fix the function signature to accept a `currencyCode` argument:\n\n```typescript\nexport function formatCurrency(\n  amount: number,\n  locale: string,\n  currencyCode: string,\n): string {\n  return new Intl.NumberFormat(locale, {\n    style: \"currency\",\n    currency: currencyCode,\n  }).format(amount);\n}\n```\n\nNow re-run all three checks:\n\n```bash\n$ npx tsc --noEmit\n# No output — type check passes\n\n$ npm run lint\n✔ All files pass linting\n\n$ npm test\n✓ 47 tests passed | 0 failed\n```\n\nAll three green. The code is safe to move to manual review.",
                "**Manual inspection — catching hallucinated APIs and wrong imports.** Here is another AI-generated block you need to review:\n\n```typescript\n// AI-generated: fetch active users and return formatted names\nimport axios from \"axios\";\n\nexport async function getActiveUserNames(apiUrl: string): Promise<string[]> {\n  const response = await axios.get(apiUrl);\n  const users: { name: string; active: boolean }[] = response.data;\n  return users.findFirst((u) => u.active).map((u) => u.name);\n}\n```\n\nWalk through the inspection checklist:\n\n1. **Wrong import** — The AI used `axios`, but your project uses the built-in `fetch` API. Check `package.json` — `axios` is not listed. This would fail at runtime in production.\n2. **Hallucinated method** — `Array.findFirst()` does not exist in JavaScript. The AI invented a plausible name. The correct method is `Array.filter()` (to get all matches) or `Array.find()` (for the first match). Here we want all active users, so `filter` is correct.\n\nHere is the corrected version:\n\n```typescript\n// Corrected: uses fetch (project standard) and real Array methods\nexport async function getActiveUserNames(apiUrl: string): Promise<string[]> {\n  const response = await fetch(apiUrl);\n  if (!response.ok) {\n    throw new Error(`Failed to fetch users: ${response.status}`);\n  }\n  const users: { name: string; active: boolean }[] = await response.json();\n  return users.filter((u) => u.active).map((u) => u.name);\n}\n```\n\nNotice the corrected version also adds error handling for the HTTP response — something the AI omitted entirely. These are the kinds of gaps that automated checks miss but manual review catches.",
                "**Writing a verification test.** The AI generated a function that clamps a number between a min and max:\n\n```typescript\n// utils/clamp.ts — AI-generated\nexport function clamp(value: number, min: number, max: number): number {\n  return Math.min(Math.max(value, min), max);\n}\n```\n\nWrite a targeted Vitest test that covers the happy path and an edge case:\n\n```typescript\n// utils/clamp.test.ts\nimport { describe, it, expect } from \"vitest\";\nimport { clamp } from \"./clamp\";\n\ndescribe(\"clamp\", () => {\n  it(\"returns the value when within range\", () => {\n    expect(clamp(5, 0, 10)).toBe(5);\n  });\n\n  it(\"clamps to min when value is below range\", () => {\n    expect(clamp(-3, 0, 10)).toBe(0);\n  });\n\n  it(\"clamps to max when value is above range\", () => {\n    expect(clamp(15, 0, 10)).toBe(10);\n  });\n\n  it(\"throws when min is greater than max\", () => {\n    expect(() => clamp(5, 10, 0)).toThrow();\n  });\n});\n```\n\nRun the tests:\n\n```bash\n$ npm test -- utils/clamp.test.ts\n ✓ returns the value when within range\n ✓ clamps to min when value is below range\n ✓ clamps to max when value is above range\n ✗ throws when min is greater than max\n   → expected function to throw, but it returned 10\n```\n\nThe edge case fails — the AI never validated its inputs. Fix the function:\n\n```typescript\nexport function clamp(value: number, min: number, max: number): number {\n  if (min > max) {\n    throw new RangeError(`min (${min}) must not be greater than max (${max})`);\n  }\n  return Math.min(Math.max(value, min), max);\n}\n```\n\nRe-run:\n\n```bash\n$ npm test -- utils/clamp.test.ts\n ✓ returns the value when within range\n ✓ clamps to min when value is below range\n ✓ clamps to max when value is above range\n ✓ throws when min is greater than max\n```\n\nAll four pass. The **prompt → generate → verify → test → accept** loop caught a real bug before it reached your codebase.",
              ],
              exerciseSteps: [
              ...
              exercises: [
                ...
                },
                {
                  ...
                  prompt:
                    "AI generates code that imports `axios` but your project uses `fetch`. What category of error is this?",
                  placeholder: "Short answer",
                  validationMode: "includes",
                  acceptedAnswers: [
                    "wrong import",
                  ...
                  hint: "Think about what the AI does NOT have access to when generating code for your specific project.",
                  assessmentType: "reasoning",
                },
                {
                  ...
                  prompt:
                    "AI writes `users.findFirst(u => u.active)`. This method doesn't exist on JavaScript arrays. What is the correct method name?",
                  placeholder: "Short answer",
                  validationMode: "exact",
                  acceptedAnswers: ["find", ".find", ".find()", "find()", "filter", ".filter", ".filter()"],
                  successMessage:
                    "Correct. JavaScript arrays have `find()` (returns first match) and `filter()` (returns all matches), but `findFirst()` is a hallucinated method the AI invented.",
              ...
              exercises: [
                {
                  ...
                  prompt:
                    "What is the FIRST section a good README should have — the one that tells a new reader what the project does?",
                  ...
                  hint: "Before setup or usage instructions, someone needs to know what the project is.",
                  assessmentType: "reasoning",
                },
                {
                  id: "comment-quality",
                  ...
                  prompt:
                    "Rewrite the useless comment `// increment i` as a useful comment for the line `retries++` in a function that calls an unreliable API.",
                  placeholder: "Short answer",
                  validationMode: "includes",
                  acceptedAnswers: [
                    "retry",
                  ...
                  hint: "A good comment explains WHY, not WHAT. Why is this counter being incremented?",
                  assessmentType: "reasoning",
                },
                {
                  id: "pr-description",
                  ...
                  prompt:
                    "A PR description should answer three questions in order. Name them.",
                  ...
                  hint: "Think about what a reviewer needs to understand: the change itself, the motivation, and how to confirm it works.",
                  assessmentType: "reasoning",
                },
              ],
              transferTask: {
              ...
              exercises: [
                {
                  ...
                  title: "README essentials",
                  prompt:
                    "What is the **clone-and-run test** for a portfolio project?",
                  placeholder: "Short list",
                  validationMode: "includes",
                  acceptedAnswers: [
                    "clone it",
                  ...
                  successMessage:
                    "Correct. The clone-and-run test means someone who has never seen your project can clone the repo, follow the README, and get it running without asking you for help.",
                  hint: "Think about what happens when a reviewer downloads your project for the first time.",
                  assessmentType: "reasoning",
                },
                {
                  ...
                  hint: "Think about what distinguishes a portfolio from a list of tutorial completions — what shows independent thinking?",
                  assessmentType: "reasoning",
                },
                {
                  ...
                  prompt:
                    "Write one line from a project decision log using the format: Considered X / Chose Y / Tradeoff Z",
                  placeholder: "Short answer",
                  validationMode: "includes",
                  acceptedAnswers: [
                    "considered",
                  ...
                  successMessage:
                    "Transfer evidence accepted. Decision logs show reviewers that you weighed alternatives and made deliberate engineering choices.",
                  hint: "Pick any technical decision from a project — a library choice, a data structure, an architecture pattern — and explain the alternatives you weighed.",
                  assessmentType: "reasoning" as const,
                },
              ],
              transferTask: {
