  ...
  return (
    ...
    >
      <div className="inspection-skill-gap">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true" className="inspection-gap-icon">
        ...
        <div>
          ...
          <span className="inspection-gap-value">{inspection.probableSkillGap}</span>
        </div>
      </div>
